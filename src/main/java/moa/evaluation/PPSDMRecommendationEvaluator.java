...
public class PPSDMRecommendationEvaluator extends AbstractMOAObject{
    ...
    public void addResult(RecommendationResults recs, int windowSize, 
        ...
        BitSet intersectGGC = UtilitiesPPSDM.computeIntersection(recs.getRecommendationsGGC(),recs.getTestWindow());
        BitSet intersectGO = UtilitiesPPSDM.computeIntersection(recs.getRecommendationsGO(),recs.getTestWindow());
        BitSet intersectOG = UtilitiesPPSDM.computeIntersection(recs.getRecommendationsOG(), recs.getTestWindow());
